...
from dynamic_network_architectures.building_blocks.dws_residual import DWS_StackedResidualBlocks, DWS_BottleneckD, DWS_BasicBlockD
from dynamic_network_architectures.building_blocks.helper import maybe_convert_scalar_to_list, get_matching_pool_op
from dynamic_network_architectures.building_blocks.dws_conv_blocks import DWS_StackedConvBlocks


class DWS_ResidualEncoder(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
        ...
        if not disable_default_stem:
            ...
            self.stem = DWS_StackedConvBlocks(1, conv_op, input_channels, stem_channels, kernel_sizes[0], 1, conv_bias,
        ...
        for s in range(n_stages):
            ...
            stage = DWS_StackedResidualBlocks(
...
if __name__ == '__main__':
    ...
    model = DWS_ResidualEncoder(3, 5, (2, 4, 6, 8, 10), nn.Conv2d, 3, ((1, 1), 2, (2, 2), (2, 2), (2, 2)), 2, False,
