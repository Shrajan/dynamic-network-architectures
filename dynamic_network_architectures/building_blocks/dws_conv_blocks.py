...
class DWS_ConvDropoutNormReLU(nn.Module):
    def __init__(self,
        ...
        super(DWS_ConvDropoutNormReLU, self).__init__()
        ...
        self.dws_conv = nn.Sequential(conv_op(
                    input_channels,
                    input_channels,
                    kernel_size,
                    stride=1,
...
class DWS_StackedConvBlocks(nn.Module):
    def __init__(self,
                 num_convs: int,
                 conv_op: Type[_ConvNd],
                 input_channels: int,
...
if __name__ == '__main__':
    ...
    stx = DWS_StackedConvBlocks(2, nn.Conv2d, 24, 16, (3, 3), 2,
